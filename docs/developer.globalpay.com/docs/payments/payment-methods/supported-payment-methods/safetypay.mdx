...
<div className="flex justify-between items-baseline">
    ...
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/migrated_images/assets/images/apms/safetypay.png" />
</div>

| **Payment Type**           | Bank Transfers                         |
| -------------------------- | -------------------------------------- |
| **Payment Method String**  | safetypay                              |
| **Available Countries**    | BR, MX, PE                             |
| **Available Currencies**   | BRL, COP, CRC, EUR, MXN, NIO, PEN, USD |
| **Min Transaction Amount** | None                                   |
| **Max Transaction Amount** | 55,000 PLN/ equivalent in EUR          |
| **Supports Refunds**       | Yes, until 90 days                     |
| **Chargebacks**            | No                                     |
| **Sandbox**                | Yes                                    |
| **Timeout**                | 1 Hour                                 |
...
<CodeGroup>
	...
	<input type="hidden" name="ORDER_ID" value ="20230203223329-63dd8bb9dea0f">
	<input type="hidden" name="AMOUNT" value ="5100">
	<input type="hidden" name="CURRENCY" value ="USD">
	<input type="hidden" name="SHA1HASH" value ="9919b3625f100f82d25c1b2686025ae66a2bc9fa">
	<input type="hidden" name="AUTO_SETTLE_FLAG" value ="1">
	<input type="hidden" name="HPP_VERSION" value ="2">
	<input type="hidden" name="HPP_CUSTOMER_COUNTRY" value ="BR">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>			
		...
		<paymentmethod>safetypay</paymentmethod>		
