...
<div className="flex justify-between items-baseline">
    ...
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/2022-07/Perlas-logo.jpeg" />
</div>

| **Payment Type**           | Cash Payments |
| -------------------------- | ------------- |
| **Payment Method String**  | perlas        |
...
<CodeGroup>
	...
	<input type="hidden" name="ORDER_ID" value ="20230203203313-63dd6f8998398">
	<input type="hidden" name="AMOUNT" value ="3800">
	<input type="hidden" name="CURRENCY" value ="EUR">
	<input type="hidden" name="SHA1HASH" value ="e4163480f4c86ca56c4bbad123ae55ba6032f95a">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>
		...
		<paymentmethod>perlas</paymentmethod>		
