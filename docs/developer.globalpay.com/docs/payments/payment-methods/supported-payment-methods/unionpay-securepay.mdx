---
title: 'UnionPay SecurePay'
tag: 'rest'
---
        
<div className="flex justify-between items-baseline">
    ## Payment Method Details
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/migrated_images/assets/images/apms/unionpay.png" />
</div>

| **Payment Type**           | Local Card             |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Payment Method String**  | upopsecurepay          |
| **Available Countries**    | AE, AT, AU, AZ, BD, BE, BN, BY, CA, CN, DE, ES, FI, FR, GB, GE, HK, HU, ID, IE, IT, JP, KE, KG, KH, KR, KZ, LB, LI, LK, LT, LU, MG, MN, MO, MT, MU, MV, MX, MY, NL, NP, NZ, PA, PF, PH, PT, RU, SC, SG, SI, SK, SR, TH, TJ, TZ, US, VN |
| **Available Currencies**   | AUD, CAD, CHF, CNY, EUR, GBP, HKD, JPY, NZD, SGD, USD  |
| **Min Transaction Amount** | 1,00 RMB/CNY           |
| **Max Transaction Amount** | 300,000 RMB/transaction; 500,000 RMB/card/day          |
...
<CodeGroup>
	...
	<input type="hidden" name="ORDER_ID" value ="20230202170122-63dbec62c02a5">
	<input type="hidden" name="AMOUNT" value ="3800">
	<input type="hidden" name="CURRENCY" value ="EUR">
	<input type="hidden" name="SHA1HASH" value ="7656a9e2ffa1db445f180daafd65bbfa89ffdaa1">
	<input type="hidden" name="AUTO_SETTLE_FLAG" value ="1">
	<input type="hidden" name="HPP_VERSION" value ="2">
	<input type="hidden" name="HPP_CUSTOMER_COUNTRY" value ="ES">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>			
		...
		<paymentmethod>unionpay</paymentmethod>		
