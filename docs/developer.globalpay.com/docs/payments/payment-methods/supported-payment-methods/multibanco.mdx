...
<div className="flex justify-between items-baseline">
    ...
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/2023-03/Multibanco.png" />
</div>

| **Payment Type**           | Bank Transfers |
| -------------------------- | -------------- |
| **Payment Method String**  | multibanco     |
| **Available Countries**    | PT             |
...
<CodeGroup>
	...
	<input type="hidden" name="ORDER_ID" value ="20230203164325-63dd39ad9939e">
	<input type="hidden" name="AMOUNT" value ="5100">
	<input type="hidden" name="CURRENCY" value ="EUR">
	<input type="hidden" name="SHA1HASH" value ="5842e8dbd1058755170c193693b1e44466549987">
	<input type="hidden" name="AUTO_SETTLE_FLAG" value ="1">
	<input type="hidden" name="HPP_VERSION" value ="2">
	<input type="hidden" name="HPP_CUSTOMER_COUNTRY" value ="PT">
