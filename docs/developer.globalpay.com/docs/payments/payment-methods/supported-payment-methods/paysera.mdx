...
<div className="flex justify-between items-baseline">
    ...
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/2022-07/paysera-logo.png" />
</div>

| **Payment Type**           | Digital Wallets |
| -------------------------- | --------------- |
| **Payment Method String**  | paysera         |
| **Available Countries**    | LT, LV, EE      |
| **Available Currencies**   | EU              |
...
<CodeGroup>
	...
	<input type="hidden" name="MERCHANT_ID" value ="gpapiqa1">
	<input type="hidden" name="ACCOUNT" value ="internet">
	<input type="hidden" name="ORDER_ID" value ="20230203221729-63dd87f92ac4b">
	<input type="hidden" name="AMOUNT" value ="5100">
	<input type="hidden" name="CURRENCY" value ="EUR">
	<input type="hidden" name="SHA1HASH" value ="964bc03821b211655c12711d887693571e15c79a">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>
		...
		<paymentmethod>paysera</paymentmethod>		
