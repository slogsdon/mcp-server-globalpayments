---
title: 'Lithuanian Banks'
tag: 'rest'
---
        
<div className="flex justify-between items-baseline">
    ## Payment Method Details
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/2022-07/Lithuanian-banks-logo.jpeg" />
</div>

| **Payment Type**           | Bank Transfers  |
| -------------------------- | --------------- |
| **Payment Method String**  | lithuanianbanks |
...
<CodeGroup>
	...
	<input type="hidden" name="ORDER_ID" value ="20230203162231-63dd34c7a85b8">
	<input type="hidden" name="AMOUNT" value ="5100">
	<input type="hidden" name="CURRENCY" value ="EUR">
	<input type="hidden" name="SHA1HASH" value ="2abd5263b2cfab4739b85d4f06591b87bb53b400">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>			
		...
		<paymentmethod>lituanianbt</paymentmethod>		
