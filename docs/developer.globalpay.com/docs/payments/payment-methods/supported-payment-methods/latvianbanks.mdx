...
<div className="flex justify-between items-baseline">
    ...
    <img alt="Logo" style={{maxWidth: "150px"}} src="/sites/default/files/2022-07/Latvian-banks-logo.png" />
</div>

| **Payment Type**           | Bank Transfers |
| -------------------------- | -------------- |
| **Payment Method String**  | latvianbanks   |
| **Available Countries**    | LV             |
...
<CodeGroup>
	...
	<input type="hidden" name="HPP_CUSTOMER_COUNTRY" value ="LV">
	...
	<request type='payment-set' timestamp='{{timestamp}}'>			
		...
		<paymentmethod>latvianbt</paymentmethod>		
